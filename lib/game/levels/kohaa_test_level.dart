...
class KohaaTestLevel extends Component
  ...
  void _createArena() {
    ...
    // Pared superior
    game.world.add(_Wall(arenaTopLeft, Vector2(arenaSize, wallThickness)));
    ...
    // Pared izquierda
    game.world.add(_Wall(arenaTopLeft, Vector2(wallThickness, arenaSize)));
  ...
  void _spawnIrrationals() {
    ...
    final positions = [Vector2(250, 400), Vector2(550, 400), Vector2(400, 550)];
